...
const PLC_PROFILE_BASES = Object.freeze({
  "keyence:kv-nano": null,
  "keyence:kv-nano-xym": "keyence:kv-nano",
  "keyence:kv-3000": null,
  "keyence:kv-3000-xym": "keyence:kv-3000",
  "keyence:kv-5000": null,
  "keyence:kv-5000-xym": "keyence:kv-5000",
  "keyence:kv-7000": null,
  "keyence:kv-7000-xym": "keyence:kv-7000",
  "keyence:kv-8000": null,
  "keyence:kv-8000-xym": "keyence:kv-8000",
  "keyence:kv-x500": null,
  "keyence:kv-x500-xym": "keyence:kv-x500",
});

function normalizePlcProfile(value) {
  if (typeof value !== "string" || !PLC_PROFILES.includes(value)) {
...
function profileDescriptors() {
  return PLC_PROFILES.map((canonicalName) =>
    Object.freeze({
      canonicalName,
      displayName: PLC_PROFILE_DISPLAY_NAMES[canonicalName],
      connectable: true,
      baseProfile: PLC_PROFILE_BASES[canonicalName],
    }),
  );
}
