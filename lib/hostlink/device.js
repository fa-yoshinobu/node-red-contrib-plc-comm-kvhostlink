...
const MWS_DEVICE_TYPES = new Set(["R", "B", "MR", "LR", "CR", "VB", "X", "Y", "M", "L", "DM", "EM", "FM", "D", "E", "F", "W", "TM", "Z", "TC", "TS", "CC", "CS", "CM", "VM"]);
...
function validateDeviceSpan(deviceType, startNumber, effectiveFormat, count = 1) {
  ...
  const wordWidth = (effectiveFormat === ".D" || effectiveFormat === ".L") && !NATIVE_32BIT_DEVICE_TYPES.has(deviceType) ? 2 : 1;
